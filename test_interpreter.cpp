...
TEST_CASE( "Test basic1", "[interpreter]" ) {
...
TEST_CASE( "Test basic2", "[interpreter]" ) {
...
TEST_CASE( "Test basic3", "[interpreter]" ) {
...
TEST_CASE( "Test basic4", "[interpreter]" ) {

  { // add, binary case
    std::string program = "(pow 1 2)";
    Expression result = run(program);
    REQUIRE(result == Expression(1.));
  }
}

TEST_CASE( "Test basic5", "[interpreter]" ) {
...
TEST_CASE( "Test basic6", "[interpreter]" ) {

  { // add, binary case
    std::string program = "(arctan 0)";
    Expression result = run(program);
    REQUIRE(result == Expression(0.));
  }
}

TEST_CASE( "Test basic7", "[interpreter]" ) {
...
TEST_CASE( "Test basic8", "[interpreter]" ) {
